...
contract DeployFilecoinCalibration is Script {
    function run() external {
        ...
        console.log("Deploying to Filecoin Calibration Testnet with account:", deployer);
        console.log("Account balance:", deployer.balance);
        console.log("Chain ID:", block.chainid);

        vm.startBroadcast(deployerPrivateKey);

        // Deploy contracts for Filecoin Calibration
        ...
        console.log("Deployment completed successfully on Filecoin Calibration Testnet!");
    }
}
